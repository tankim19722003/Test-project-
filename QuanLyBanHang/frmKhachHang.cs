    ...
    public partial class frmKhachHang : Form
    {
        ...
        void LoadData()
        {
            try
            {
                ...
                this.txtDiachi.ResetText(); // CODE SỬA
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Them)
            {
                try
                {
                    ...
                    String diaChi = this.txtDiachi.Text.ToString();
                    String dienThoai = this.txtDienthoai.Text.ToString();

                    if (String.IsNullOrWhiteSpace(maKH) || String.IsNullOrWhiteSpace(tenCty) || isWhiteSpace(diaChi) || !isNumber(dienThoai))
                    {
                    ...
                    else
                    {
                        ...
                        maKH + "',N'" + tenCty + "',N'" + diaChi + "',N'" + this.cbThanhPho.SelectedValue.ToString() + "',N'" +
                        dienThoai + "')");
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        cmd.CommandText = System.String.Concat("Update KhachHang Set TenCty=N'" +
                            tenCty + "', Diachi =N'" +
                            diaChi + "', ThanhPho =N'" + this.cbThanhPho.SelectedValue.ToString()
                            + "', DienThoai =N'" + dienThoai + "', MaKH =N'" + maKH +
                            "' where MaKH ='" + strMAKH + "'");
                        //Cập nhật
                        cmd.CommandType = CommandType.Text;
                        cmd.ExecuteNonQuery();
